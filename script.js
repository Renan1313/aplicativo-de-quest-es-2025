...
function mostrarQuestao() {
    ...
    // Leitura da pergunta
    falar(questao.pergunta);
    
    // Leitura das alternativas
    alternativas.forEach((alt, i) => falar(`Alternativa ${i + 1}: ${questao.alternativas[i]}`));
...
// Função para falar o texto (uso da API SpeechSynthesis)
function falar(texto) {
    const msg = new SpeechSynthesisUtterance(texto);
    msg.lang = 'pt-BR'; // Configuração para Português
